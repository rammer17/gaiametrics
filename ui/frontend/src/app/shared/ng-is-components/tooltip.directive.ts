    ...
    switch (this.tooltipPos) {
      case "top":
        tooltipContainerY = `${
          ...
          tooltipArrowEl.offsetHeight * 2
        }px`;
        tooltipContainerX = `${
          targetDOMRect.left +
          targetDOMRect.width / 2 -
          tooltipContentEl.offsetWidth / 2
        }px`;

        tooltipArrowY = ``;
        tooltipArrowX = `${
          tooltipContentEl.offsetWidth / 2 - tooltipArrowEl.offsetWidth / 2
        }px`;
        break;
      ...
      case "bottom":
        ...
        tooltipArrowY = `${
          tooltipContentEl.offsetHeight + tooltipArrowEl.offsetHeight
        }px`;
        tooltipArrowX = `${
          tooltipContentEl.offsetWidth / 2 - tooltipArrowEl.offsetWidth / 2
        }px`;
      ...
      case "left":
        tooltipContainerY = `${
          ...
          targetDOMRect.height / 2
        }px`;
        tooltipContainerX = `${
          targetDOMRect.left -
          tooltipContentEl.offsetWidth -
          tooltipArrowEl.offsetWidth
        }px`;

        tooltipArrowY = `${
          tooltipContentEl.offsetHeight / 2 + tooltipArrowEl.offsetWidth / 4
        }px`;
        tooltipArrowX = `${
          tooltipContentEl.offsetWidth - tooltipArrowEl.offsetWidth / 4
        }px`;
